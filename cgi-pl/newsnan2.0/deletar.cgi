...
open(bd,"novidades.txt"); 
@bd = <bd>; 
close(bd); 
chomp(@bd); 
open(bd,">novidades.txt"); 
foreach $bd (@bd) { 
if($bd eq "$inome``$email``$imagem``$data``$imensagem``$titulo``$codigo") { next; } 
print bd"$bd\n"; 
} 
close(bd); 
...
<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse\" bordercolor=\"#111111\" width=\"100%\" id=\"AutoNumber1\">
  ...
  <tr>
    ...
    <p align=\"center\"><p align=\"center\"><font face=\"Verdana\" size=\"1\">
Mensagem Deletada com sucesso</font></p>
<p align=\"center\"><form method=\"POST\" action=\"deletar_msg.cgi\">
<input type=\"hidden\" name=\"senha\" value=\"renan\">
