# Action library for sdbappsedit
...
$String = $main::Config{sdb}{message}{error}. $main::Config{$main::Form{c}}{error} . $main::Config{$main::Form{c}{ok}} . $String;
$main::Html{ServiceText} =~ s!<insert-sdbappsedit-content>!$String!gis;
};
1;
