 ...
 * Version: 4.16
 * Created: 2002-05-28
 * Updated: 2002-06-07	Updated default cssFile value to "skins/winclassic.css"
 *						instead of "winclassic.css"
 *			2002-06-10	Lots of changes. Rewrote measuring and positioning routines
 *						to prevent screen flicker. As well as general code optimization.
 ...
 *			2002-07-25	Created a work around for a weird bug that did not show first menu
 *						Disabled borwser keyboard shortcuts when menus are open
 *						Added workaround for buggy dual monitor drivers
 *			2002-09-05	Fixed cases where teh caching of the CSS failed and
 *						caused the cached menu size to be incorrect
...
Menu.prototype.hookupMenu = function ( d ) {
	...
	scrollContainer.attachEvent( "onscroll", function () {
